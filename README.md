...
This project implements a service-oriented version of a ticket purchase application (i.e., your own EventBrite!). 
...
1. Project uses Servlets/Jetty as your web framework.
2. Project uses a SQL database to store all data including user information, event information, and ticket transaction/purchase information. Though I am using the same centralized database for each service, to accurately mimic a service-oriented architecture, I ensure that one service does *not* access the database tables of the other service. Instead, services should communicate via the API implemented.
